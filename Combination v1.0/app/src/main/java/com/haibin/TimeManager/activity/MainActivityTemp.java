...
public class MainActivityTemp extends AppCompatActivity {
        ...
        public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
            if (actionState == OnItemStateChangedListener.ACTION_STATE_DRAG) {
                ...
                viewHolder.itemView.setBackgroundColor(
                        ContextCompat.getColor(MainActivityTemp.this, R.color.white_pressed));
            } else if (actionState == OnItemStateChangedListener.ACTION_STATE_SWIPE) {
            } else if (actionState == OnItemStateChangedListener.ACTION_STATE_IDLE) {
                // 在手松开的时候还原背景。
                ViewCompat.setBackground(viewHolder.itemView,
                        ContextCompat.getDrawable(MainActivityTemp.this, R.drawable.select_white));
            }
        }
    };
    ...
    private final OnItemMoveListener onItemMoveListener = new OnItemMoveListener() {
        ...
        public void onItemDismiss(RecyclerView.ViewHolder srcHolder) {
            ...
            //在这里弹出一个对话框
            new AlertDialog.Builder(MainActivityTemp.this)
                    .setMessage("确定要删除该事件？"+todoname)
                    .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(MainActivityTemp.this, "你点击了确定按钮~", Toast.LENGTH_SHORT).show();
                            Todo updatetodo=new Todo();
                            ...
                            Toast.makeText(MainActivityTemp.this, "现在的第" + position + "条被删除。", Toast.LENGTH_SHORT).show();
                        }
                    })
