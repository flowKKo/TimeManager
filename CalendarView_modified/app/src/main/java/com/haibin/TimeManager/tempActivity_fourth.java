...
public class tempActivity_fourth extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_todo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(tempActivity_fourth.this, showActivity.class);
        ...
        button_calendar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(tempActivity_fourth.this, FullActivity.class);
                startActivity(intent);
            }
        });
        ...
        button_clock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(tempActivity_fourth.this, tempActivity_third.class);
                startActivity(intent);
            }
        });
        ...
        button_statistics.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(tempActivity_fourth.this, tempActivity_fourth.class);
                startActivity(intent);
            }
        });
