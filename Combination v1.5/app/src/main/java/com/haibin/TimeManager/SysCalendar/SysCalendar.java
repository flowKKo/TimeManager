...
public class SysCalendar {
    ...
    //添加日历事件、日程
    public static boolean addCalendarEvent(Context context, String title, String description, Date date, Time time) {
        // 获取日历账户的id
    ...
    //更新日历事件、日程
    public static void updateCalendarEvent(Context context,String title, String description, Date date, Time time){
        deleteCalendarEvent(context,title);//先删除原来的event
        addCalendarEvent(context,title,description,date,time);//然后再添加新的event
    }
